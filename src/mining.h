...
static const int64_t nBlockRewardReserve = 140000 * COIN; // premine 14,000,000 ARION
...
inline int64_t MasternodeCollateral(int nHeight) { return 50000; } // 50 thousand ARION required as collateral
/** MasterNode required collateral */
inline int64_t MasternodeCollateral_Tier_2(int nHeight) { return 1000000; } // 1 Million ARION required as collateral (Tier 2)
