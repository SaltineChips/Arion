 ...
 * The Arion Developers 2018-2020
 */
...
ArionGUI::ArionGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
...
#endif
    setObjectName("Arion");
    setStyleSheet("#Arion {background-image: url(:/images/qt) }");
    ...
    if (!fUseDarkTheme)
    {
        statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: #00ffc6; }");
    }
...
void ArionGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About Arion"), this);
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Arion.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for Arion"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Arion.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for Arion (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where Arion data is stored"));
...
void ArionGUI::createToolBars()
{
    ...
    if(!fUseDarkTheme)
    {
        toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold; } QToolButton:hover { background-color: #e1c13e; } QToolButton:checked { background-color: #af9630; } QToolButton:pressed { background-color: #c8ac37; } #tabs { color: #ffffff; background-color: #00ffc6; }");
    }
...
void ArionGUI::setClientModel(ClientModel *clientModel)
{
    if(!fOnlyTor)
...
void ArionGUI::setWalletModel(WalletModel *walletModel)
{
...
void ArionGUI::setMessageModel(MessageModel *messageModel)
{
...
#ifndef Q_OS_MAC
void ArionGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void ArionGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void ArionGUI::setNumBlocks(int count)
{
    QString tooltip;
    ...
    else
    {
        ...
        if(!fUseDarkTheme){
        progressBarLabel->setStyleSheet("QLabel { color: #ffffff; background-color: #00ffc6; }");
        }
...
void ArionGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
...
void ArionGUI::error(const QString &title, const QString &message, bool modal)
{
...
void ArionGUI::changeEvent(QEvent *e)
{
...
void ArionGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void ArionGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(ArionUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void ArionGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(ArionUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void ArionGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void ArionGUI::gotoMasternodeManagerPage()
{
...
void ArionGUI::gotoBlockBrowser()
{
...
void ArionGUI::gotoOverviewPage()
{
...
void ArionGUI::gotoAddressBookPage()
{
...
void ArionGUI::gotoReceiveCoinsPage()
{
...
void ArionGUI::gotoSendCoinsPage()
{
...
void ArionGUI::gotoSignMessageTab(QString addr)
{
...
void ArionGUI::gotoVerifyMessageTab(QString addr)
{
...
void ArionGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void ArionGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
void ArionGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void ArionGUI::setEncryptionStatus(int status)
{
...
void ArionGUI::importPrivateKey()
{
...
void ArionGUI::changePassphrase()
{
...
void ArionGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void ArionGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void ArionGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void ArionGUI::updateStakingIcon()
{
    updateWeight();
...
void ArionGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void ArionGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
