...
/**
  Arion GUI main class. This class represents the main window of the Arion UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ArionGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit ArionGUI(QWidget *parent = 0);
    ~ArionGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a Arion  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
