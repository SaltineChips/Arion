...
std::string HelpMessage()
{
    ...
    strUsage += "\n" + _("SSL options: (see the Arion Wiki for SSL setup instructions)") + "\n";
...
/** Sanity checks
 *  Ensure that Arion is running in a usable environment with all
...
#endif
    // Make sure only a single Arion process is using the data directory.
