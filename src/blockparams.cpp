...
// Copyright (c) 2020 The Arion project
...
//
//
// Reward calculations for 25-years of ARION emissions
// 10 Billion Total     | 8 Billion Premine
// 100% Remaining ARION   : 2,000,000,000
// ----------------------------------
...
// Payout per block     : 300 ARION
// Payout per day       : 300 * ((1 * 60 * 60) / (2 * 60) * 24)                   =       216,000 ARION
// Payout per month     : 300 * (((1 * 60 * 60) / (2 * 60) * 24) * 30)            =     6,480,000 ARION
// Payout per year      : 300 * (((1 * 60 * 60) / (2 * 60) * 24) * 365)           =    78,840,000 ARION
// Mineout              : 300 * (25.36 * (((1 * 60 * 60) / (2 * 60) * 24) * 365)) = 2,000,000,000 ARION
// ----------------------------------
// (Network Allocation) (BLOCKS | 25-Years of minting)
// Singular Payout      : 150-->50 ARION
// Maternode Payout     : 100-->200 ARION
// DevOps Payout        : 50 ARION
// ----------------------------------
// (PLEASE NOTE)
...
{
    int64_t nSubsidy = (1.25 * COIN); // PoS Staking - pindexPrev is info from the last block, and -> means to get specific info from that block. Getblocktime is the epoch time of that block.
...
{
    int64_t ret2 = 0;
    ret2 = (0.25) * COIN; // 12.5 ARION per block = 10% of blocks.
